 ...
 */
@Autonomous (name = "AutoBot Blue Side 1.3", group = "blue")
//@Disabled
public class AutoBotBlue1_4 extends LinearOpMode
{
    ...
    static final double     TURN_SPEED              = 0.625;
    static final double     SLOW_SPEED              = 0.45;
...
//start game
        ...
        if (sensorColor.red() > robot.RED)
            telemetry.addData("Color", "Red");
        if (sensorColor.red() > robot.RED)
            robot.servohand.setPosition(Servo.MAX_POSITION);
        //safety
        if (sensorColor.blue() > robot.BLUE)
            telemetry.addData("color", "Blue");
        if (sensorColor.blue() > robot.BLUE)
            robot.servohand.setPosition(Servo.MIN_POSITION);
        ...
        encoderDrive(DRIVE_SPEED,5,-5,-5,5,0.75); //right
        ...
        encoderDrive(TURN_SPEED,-35,-35,35,35,2.5); //180* turn
        ...
        gyroDrive(DRIVE_SPEED, 7,180);
        gyroDrive(DRIVE_SPEED,-7,180);
        gyroDrive(DRIVE_SPEED, 7,180);

        encoderDrive(DRIVE_SPEED,14,-14,-14,14,1.0);//right
        ...
        gyroDrive(DRIVE_SPEED,-7,180); //forward
        gyroDrive(DRIVE_SPEED,7,180); //backward
        ...
        gyroDrive(DRIVE_SPEED,-12,180); //forward
        gyroDrive(CONTROL_SPEED,3,180);//backward
